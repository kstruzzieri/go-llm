...
// containment. Zero options reproduce the legacy set byte-for-byte. Returned
// only when interactive -allow-exec is set (one-shot drops the flag;
// -plan/-goal reject it at validation).
