...
// argument invariants (block) and the egress classifier (tag). They are
// value types safe for concurrent use.
func Defaults() []agent.Interceptor {
	return []agent.Interceptor{ZeroWidth{}, Encoding{}, Typoglycemia{}, mustInvariants(DefaultInvariants()), Egress{}}
}
