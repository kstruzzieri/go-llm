...
func classifyAppServerError(err error) *Error {
	...
	if errors.As(err, &fault) && appServerPoints[fault.point] && (errors.Is(err, errAppServerProtocolInitialize) ||
...
// appServerPoints is the closed set of host-authored rejection points that may
// be appended to a phase reason. TestAppServerPointsMatchSource keeps it equal to
// the literals in codex_app_server_protocol.go in both directions, so a new point
// cannot silently degrade to the phase-only reason.
var appServerPoints = map[string]bool{
	"account-login-completed-rejected":                     true,
	"active-correlation":                                   true,
	"agent-message-delta-rejected":                         true,
	"app-list-updated-rejected":                            true,
	"auto-approval-review-completed-rejected":              true,
	"auto-approval-review-started-rejected":                true,
	"auto-approval-review-strict-review-required-rejected": true,
	"command-exec-output-delta-rejected":                   true,
	"command-execution-output-delta-rejected":              true,
	"command-execution-terminal-interaction-rejected":      true,
	"error-notification-rejected":                          true,
	"external-agent-config-import-completed-rejected":      true,
	"external-agent-config-import-progress-rejected":       true,
	"file-change-output-delta-rejected":                    true,
	"file-change-patch-updated-rejected":                   true,
	"fs-changed-rejected":                                  true,
	"fuzzy-file-search-session-completed-rejected":         true,
	"fuzzy-file-search-session-updated-rejected":           true,
	"guardian-warning-rejected":                            true,
	"hook-completed-rejected":                              true,
	"hook-started-rejected":                                true,
	"initialize-reply":                                     true,
	"item-agent-citation":                                  true,
	"item-agent-questions":                                 true,
	"item-agent-shape":                                     true,
	"item-bound":                                           true,
	"item-collab-agent-tool-call-rejected":                 true,
	"item-command-execution-rejected":                      true,
	"item-context-compaction-rejected":                     true,
	"item-dynamic-tool-call-rejected":                      true,
	"item-entered-review-mode-rejected":                    true,
	"item-exited-review-mode-rejected":                     true,
	"item-file-change-rejected":                            true,
	"item-function-call-output-rejected":                   true,
	"item-hook-prompt-rejected":                            true,
	"item-image-generation-rejected":                       true,
	"item-image-view-rejected":                             true,
	"item-lifecycle":                                       true,
	"item-mcp-tool-call-rejected":                          true,
	"item-plan-rejected":                                   true,
	"item-prompt-echo":                                     true,
	"item-reasoning-content":                               true,
	"item-reasoning-shape":                                 true,
	"item-shape":                                           true,
	"item-sleep-rejected":                                  true,
	"item-sub-agent-activity-rejected":                     true,
	"item-timing":                                          true,
	"item-unknown":                                         true,
	"item-user-content":                                    true,
	"item-user-elements":                                   true,
	"item-user-shape":                                      true,
	"item-web-search-rejected":                             true,
	"mcp-server-event-stream-notification-rejected":        true,
	"mcp-server-oauth-login-completed-rejected":            true,
	"mcp-startup-error":                                    true,
	"mcp-startup-failed":                                   true,
	"mcp-startup-failure-reason":                           true,
	"mcp-startup-name":                                     true,
	"mcp-startup-shape":                                    true,
	"mcp-startup-status":                                   true,
	"mcp-startup-thread":                                   true,
	"mcp-tool-call-progress-rejected":                      true,
	"method-shape":                                         true,
	"model-cursor":                                         true,
	"model-list-bound":                                     true,
	"model-list-shape":                                     true,
	"model-page-bound":                                     true,
	"model-provider-auth-recovery-completed-rejected":      true,
	"model-provider-auth-recovery-started-rejected":        true,
	"model-rerouted-rejected":                              true,
	"model-safety-buffering":                               true,
	"model-shape":                                          true,
	"model-verification":                                   true,
	"notification-before-initialize":                       true,
	"notification-envelope":                                true,
	"notification-order":                                   true,
	"notification-shape":                                   true,
	"notification-unknown":                                 true,
	"plan-delta-rejected":                                  true,
	"process-exited-rejected":                              true,
	"process-output-delta-rejected":                        true,
	"project-changed-rejected":                             true,
	"rate-limits-shape":                                    true,
	"raw-response-completed-rejected":                      true,
	"raw-response-item-completed-rejected":                 true,
	"reasoning-summary-part-added-rejected":                true,
	"reasoning-summary-text-delta-rejected":                true,
	"reasoning-text-delta-rejected":                        true,
	"record-array-bound":                                   true,
	"record-before-start":                                  true,
	"record-decode":                                        true,
	"record-envelope":                                      true,
	"record-framing":                                       true,
	"remote-status":                                        true,
	"reply-correlation":                                    true,
	"reply-envelope":                                       true,
	"reply-id":                                             true,
	"reply-method":                                         true,
	"request-envelope":                                     true,
	"rpc-error-shape":                                      true,
	"server-request-resolved-rejected":                     true,
	"skills-shape":                                         true,
	"start-state":                                          true,
	"system-error-rejected":                                true,
	"terminal-answer-missing":                              true,
	"terminal-items":                                       true,
	"terminal-items-incomplete":                            true,
	"terminal-summary":                                     true,
	"terminal-summary-mismatch":                            true,
	"thread-archived-rejected":                             true,
	"thread-compacted-rejected":                            true,
	"thread-correlation":                                   true,
	"thread-deleted-rejected":                              true,
	"thread-environment-connected-rejected":                true,
	"thread-environment-disconnected-rejected":             true,
	"thread-goal-cleared-rejected":                         true,
	"thread-goal-updated-rejected":                         true,
	"thread-instructions":                                  true,
	"thread-name":                                          true,
	"thread-project-updated-rejected":                      true,
	"thread-queue-changed-rejected":                        true,
	"thread-realtime-closed-rejected":                      true,
	"thread-realtime-error-rejected":                       true,
	"thread-realtime-item-added-rejected":                  true,
	"thread-realtime-item-completed-rejected":              true,
	"thread-realtime-item-started-rejected":                true,
	"thread-realtime-item-transcript-delta-rejected":       true,
	"thread-realtime-output-audio-delta-rejected":          true,
	"thread-realtime-sdp-rejected":                         true,
	"thread-realtime-started-rejected":                     true,
	"thread-realtime-transcript-delta-rejected":            true,
	"thread-realtime-transcript-done-rejected":             true,
	"thread-reply-identity":                                true,
	"thread-reply-profile":                                 true,
	"thread-reply-shape":                                   true,
	"thread-reverted-rejected":                             true,
	"thread-settings-updated-rejected":                     true,
	"thread-started-identity":                              true,
	"thread-status":                                        true,
	"thread-unarchived-rejected":                           true,
	"turn-diff-updated-rejected":                           true,
	"turn-error":                                           true,
	"turn-id":                                              true,
	"turn-items":                                           true,
	"turn-moderation-metadata-rejected":                    true,
	"turn-order":                                           true,
	"turn-plan-updated-rejected":                           true,
	"turn-reply-shape":                                     true,
	"turn-shape":                                           true,
	"turn-status":                                          true,
	"turn-timing":                                          true,
	"turn-view":                                            true,
	"usage-counters":                                       true,
	"usage-monotonic":                                      true,
	"usage-shape":                                          true,
	"usage-window":                                         true,
	"windows-sandbox-setup-completed-rejected":             true,
	"windows-world-writable-warning-rejected":              true,
}
